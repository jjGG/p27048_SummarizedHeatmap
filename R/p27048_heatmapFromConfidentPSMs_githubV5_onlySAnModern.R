...
View(ss)
write_tsv(x = ss, file = "ColorScheme_forSamples_forShevan2check_noLocations_2025-05-20.tsv")
...
write_tsv(colorNproteins, file = "ColorSchemeForProteins_date_forShevan2check_specialProteinsOut.tsv")
...
# plotting
(fN <- paste(fgczProject, "_", descri, "_min5psms_someRowNcolSideColout", ".pdf",sep = ""))
pdf(fN, 35,35)
# Create the heatmap with row side colors list
heatmap.plus(
...
(fN <- paste(fgczProject, "_", descri, "_noBlanks_min10psms_someRowNcolSideColout", ".pdf",sep = ""))
pdf(fN, 31,31)
# Create the heatmap with row side colors list
heatmap.plus(
  filtMat_min10,
...
(fN <- paste(fgczProject, "_", descri, "_noBlanks_min20psms_someRowNcolSideColout", ".pdf",sep = ""))
pdf(fN, 25,25)
heatmap.plus(
  filtMat_min20,
  Rowv = FALSE,
